...
```
    ...
    Info: Working in directory C:/Users/patri/OneDrive/Desktop/bimm143_github/class14
...
The most significant pathways are similar to the KEGG results in that
they both mention the “cell cycle” and “meiosis”. Reactome slightly
differs in that it specifies the specific process step (ex:DNA
replication). The differences from these methods is due to the level of
depth that each database goes into regarding their results which can
affect both the number of genes displayed in the path way and the
retrieved p-values from the results.
